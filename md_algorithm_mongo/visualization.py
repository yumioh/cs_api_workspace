...
plt.scatter(arranged_accident.index, arranged_accident, color="dodgerblue", label="GH",s=8)
plt.scatter(arranged_non_accident.index, arranged_non_accident, color="red", alpha=0.4, label="KOSHA", s=8)
